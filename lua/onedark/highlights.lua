...
local diagnostics_error_color = c.diagnostics_error_darker and c.diagnostics_error or c.red
local diagnostics_hint_color = c.diagnostics_hint_darker and c.diagnostics_hint or c.purple
local diagnostics_warn_color = c.diagnostics_warn_darker and c.diagnostics_warn or c.yellow
local diagnostics_info_color = c.diagnostics_info_darker and c.diagnostics_info or c.cyan
hl.plugins.lsp = {
